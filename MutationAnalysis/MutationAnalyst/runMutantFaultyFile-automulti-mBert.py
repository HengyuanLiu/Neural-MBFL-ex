...
MUTANT_FAULTYFILE = SOFTWARE_TESTING_ROOT/"Mutation/NeuralMutation/mbert/MutantRepo/Defects4J/Mutant4FaultyFile" 

D4J_Origin = SOFTWARE_TESTING_ROOT/"DataSet/Defects4J/D4J/project_repository"
Mutant_Log_Faulty_File = SOFTWARE_TESTING_ROOT/"MutationAnalysis/MutantTestResult/NeuralMutation/mBERT/Defects4J/mutantlog_faulty_file"
Mutant_Testing_Log = SOFTWARE_TESTING_ROOT/"MutationAnalysis/MutantTestResult/NeuralMutation/mBERT/Defects4J/runMutantLog" 
Mutant_Test_Result_Faulty_File = SOFTWARE_TESTING_ROOT/"MutationAnalysis/MutantTestResult/NeuralMutation/mBERT/Defects4J/result4FaultFile"
...
def execMutant(pid, mutantPath, process_name, D4J_Repo_Path): 
  for i in mutantPath:
    ...
    sourceFilePath = D4J_Repo_Path / pid / f"{pid.lower()}_{vid}_buggy" 
...
if __name__ == '__main__':
    ...
    if pid in ["Collections", "JacksonDatabind", "JxPath"]:
        ...
        D4J_Repo_Path = D4J_Clean
    startProcess(MUTANT_FAULTYFILE, pid, 1, 112, num_threads=8, D4J_Repo_Path=D4J_Repo_Path)